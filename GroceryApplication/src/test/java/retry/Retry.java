...
public class Retry implements IRetryAnalyzer { //IRetryAnalyzer interface is available in testng. 
	...
	@Override //retry method is predefined in interface IRetryAnalyzer. To customize data, we use @Override
